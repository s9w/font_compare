...
def add_font(name, default_size_small=10, default_size_big=20, aa_sizes=font_sizes_default):
    ...
    font_info["default"] = default_size_small
    font_infos[name] = font_info


add_font(name="Anonymous Pro", default_size_small=11, aa_sizes={"aa0": [7,8,9,10,11,12], "aa1": [11,12]})
add_font(name="Bitstream Vera Sans Mono")
add_font(name="Consolas", default_size_small=11)
add_font(name="Courier Prime")
add_font(name="Classic Console", default_size_small=16, aa_sizes={"aa0": [16], "aa1": []})
add_font(name="DejaVu Sans Mono")
add_font(name="Dina", aa_sizes={"aa0": [8,9,10], "aa1": []})
add_font(name="Droid Sans Mono")
add_font(name="Envy Code R", default_size_small=11)
add_font(name="Fantasque Sans Mono", default_size_small=11)
...
add_font(name="Iosevka", default_size_small=11, aa_sizes={"aa0": [8,9,10,11], "aa1": [8,9,10,11]})
add_font(name="Liberation Mono")
add_font(name="Luculent", default_size_small=11)
add_font(name="Luxi Mono")
add_font(name="M+ 1m regular", default_size_small=12)
add_font(name="M+ 1m medium", default_size_small=12)
add_font(name="M+ 1m light", default_size_small=12)
add_font(name="Menlo")
add_font(name="Mensch")
add_font(name="Meslo LG S")
add_font(name="Meslo LG M")
add_font(name="Meslo LG L")
add_font(name="Monofur", default_size_small=11)
add_font(name="Monoid", default_size_small=11)
...
add_font(name="OpenDyslexicMono", default_size_small=8)
add_font(name="PragmataPro", default_size_small=11)
add_font(name="ProFontWindows", default_size_small=12, aa_sizes={"aa0": [8,10,11,12], "aa1": [8,10,11,12]})
...
add_font(name="Ubuntu Mono", default_size_small=12)
add_font(name="InputMono")
add_font(name="InputMonoCondensed")
add_font(name="Hack")
